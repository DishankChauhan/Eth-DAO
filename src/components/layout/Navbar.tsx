        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <div className="hidden md:flex ml-10 space-x-8">
              <Link 
                href="/proposals" 
                className={`px-3 py-2 text-sm font-medium ${pathname === '/proposals' ? 'text-white' : 'text-gray-300 hover:text-white'}`}
              >
                Proposals
              </Link>
              <Link 
                href="/delegates" 
                className={`px-3 py-2 text-sm font-medium ${pathname === '/delegates' ? 'text-white' : 'text-gray-300 hover:text-white'}`}
              >
                Delegates
              </Link>
              <Link 
                href="/dashboard" 
                className={`px-3 py-2 text-sm font-medium ${pathname === '/dashboard' ? 'text-white' : 'text-gray-300 hover:text-white'}`}
              >
                Dashboard
              </Link>
              {user?.walletAddress && (
