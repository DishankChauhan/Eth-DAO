...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const login = async (address: string) => {
    try {
      ...
      // Check if the address is an admin (add your own wallet address here)
      const adminAddresses = [
        '0xDE789a8e092004e196ac4A88Cd39d5aB8852402c',
        '0x775F4A912a09291Ae31422b149E0c37760C7AB02',
        // Add your connected wallet address here to access admin page
      ];
      ...
      logger.debug('Wallet connected:', { address, isAdmin });
    } catch (error) {
